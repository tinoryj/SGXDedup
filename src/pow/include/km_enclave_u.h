...
sgx_status_t ecall_keygen(sgx_enclave_id_t eid, sgx_status_t* retval, sgx_ra_context_t* ctx, sgx_ra_key_type_t type, uint8_t* src, uint32_t srcLen, uint8_t* keyd, uint32_t keydLen, uint8_t* keyn, uint32_t keynLen, uint8_t* key);
