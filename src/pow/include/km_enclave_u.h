...
sgx_status_t ecall_keygen_ctr(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* src, uint32_t srcLen, uint8_t* key);
...
sgx_status_t ecall_setNextEncryptionMask(sgx_enclave_id_t eid, sgx_status_t* retval, int clientID)
