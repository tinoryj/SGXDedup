...
sgx_status_t ecall_keygen_ctr(sgx_enclave_id_t eid, sgx_status_t* retval, uint8_t* src, uint32_t srcLen, uint8_t* key, int clientID, uint32_t previousCounter, uint32_t currentCounter, uint8_t* nonce, uint32_t nonceLen);
