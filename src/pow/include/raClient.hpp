...
#ifndef GENERALDEDUPSYSTEM_RACLIENT_HPP
#define GENERALDEDUPSYSTEM_RACLIENT_HPP
...
public:
    bool doAttestation(sgx_enclave_id_t &eid,sgx_ra_context_t &ctx);
...
#endif //GENERALDEDUPSYSTEM_RACLIENT_HPP
